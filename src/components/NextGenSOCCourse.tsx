              ...
              <div className="mt-6 animate-fade-in">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {nextGenScenarios.map((scenario) => (
                    <div key={scenario.id} className="bg-gray-800/50 p-6 rounded-lg border border-gray-600/30 hover:border-green-500/50 transition-all duration-300 cursor-pointer group"
                      ...
                      <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        ...
                        <div className="text-center mt-2 text-green-300 text-sm font-bold">
                          🤖 AI 훈련 시작하기
                        </div>
                      </div>
                    </div>
